...
class PatientTrackerProcedureModel {
  String? patientProcedureDbId;
  PatientProcedure? patientProcedure;
  bool? response;
  int? statusCode;

  PatientTrackerProcedureModel(
      {this.patientProcedureDbId,
      this.patientProcedure,
      this.response,
      this.statusCode});

  PatientTrackerProcedureModel.fromJson(Map<String, dynamic> json) {
...
class Detail {
  ...
  Detail({this.day, this.date, this.isToday, this.events, this.isPastDate});
...
class Events {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.uploads != null) {
      data['uploads'] = this.uploads!.toList();
    }
    return data;
  }
}
